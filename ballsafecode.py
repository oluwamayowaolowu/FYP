...
greenLower = (83,0,93) #(102,31,75) (150,68,255) #white ball day time (83,0,93)(176,102,255)
...
linedist= dist.euclidean((ax1, ay1), (bx1, by1))
print("dist is ")
print(linedist)
...
while True:
	...
	cv2.line(frame,(ax1,ay1),(ax2,ay2),(255,0,0),2)
    #line b
...
# find contours in the mask and initialize the current
	...
	# update the points queue
		while int(ay1) == int((y+y)/2):
			start_time = time.time()
			break
		while int(ay1) <= int((y+ y)/2):
			if int(by1) <= int(y)&int(by1+10) >= int(y):
				cv2.line(frame,(bx1,by1),(bx2,by2),(0,255,0),2)
				Speed = Speed_Cal(time.time() - start_time)
				print("Time Taken:" + str(Speed))
