...
img_path = "frame50.jpg"

orangeLower = (0,160,0) # red candle(0,174,77)(179,231,146)
...
mask = cv2.inRange(blur, orangeLower, orangeUpper)
masked = cv2.Canny(mask, 50, 100)
edged = cv2.dilate(masked, None, iterations=1)
